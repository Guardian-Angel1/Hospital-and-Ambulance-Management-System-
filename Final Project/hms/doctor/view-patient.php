...
<html lang="en">
	<head>
		<title>IITG-HMS | Doctor | View Patient</title>
...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle" style=" color: #003366; ">Doctor | View Patients</h1>
</div>
<ol class="breadcrumb">
<li>
<span>Doctor</span>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <tr>
    ...
    <th>Prescription :</th>
    <td>
    <textarea name="pres" placeholder="Prescribe" rows="12" cols="14" class="form-control wd-450" required="true"></textarea></td>
  </tr>  
