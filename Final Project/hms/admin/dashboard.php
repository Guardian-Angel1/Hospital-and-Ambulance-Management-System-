...
<html lang="en">
	<head>
		<title>IITG-HMS | Admin | Dashboard</title>
...
<?php include('include/sidebar.php');?>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<!-- start: BASIC EXAMPLE -->
							...
							<h1 class="mainTitle"  style=" color: #003366; "><strong>Admin | Dashboard</strong></h1>
							<div class="row">
							<div class="col-sm-4">
    ...
    <i class="fa fa-user-md fa-stack-1x fa-inverse"></i> 
											...
											<p class="cl-effect-1" style="font-size: 1.5em; ">
								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<p class="links cl-effect-1" style="font-size: 1.5em; ">
								...
								<div class="col-sm-4">
									...
									<h2 class="StepTitle"> Doctor Logs</h2>
											...
											$num_rows22 = mysqli_num_rows($sql);
											?>
											Total Sesions :<?php echo htmlentities($num_rows22);   ?>	
												</a>
								...
								<h2 class="StepTitle"> User Logs</h2>
											...
											$num_rows22 = mysqli_num_rows($sql);
											?>
											Total Sessions :<?php echo htmlentities($num_rows22);   ?>	
												</a>
							...
							<h2 class="StepTitle"> All Patients</h2>
