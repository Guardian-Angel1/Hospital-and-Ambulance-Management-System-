...
$pagedes=$con->real_escape_string($_POST['pagedes']);
     $query=mysqli_query($con,"update hmstblpage set PageTitle='$pagetitle',PageDescription='$pagedes' where  PageType='aboutus'");
    if ($query) {
...
<html lang="en">
	<head>
		<title>IITG-HMS | Admin | About Us </title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle" style=" color: #003366; "> Admin  | About Us Content</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin </span>
...
$ret=mysqli_query($con,"select * from  hmstblpage where PageType='aboutus'");
$cnt=1;
