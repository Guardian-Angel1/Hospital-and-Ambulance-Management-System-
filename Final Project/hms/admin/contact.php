...
$email=$_POST['email'];
 $mobnum=$_POST['mobnum'];
     $query=mysqli_query($con,"update hmstblpage set PageTitle='$pagetitle',PageDescription='$pagedes',Email='$email',MobileNumber='$mobnum' where  PageType='contactus'");
    if ($query) {
...
<html lang="en">
	<head>
		<title>IITG-HMS | Admin | Contact Us </title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle" style=" color: #003366; ">Admin  | Update the Cotnact us Content</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin </span>
...
$ret=mysqli_query($con,"select * from  hmstblpage where PageType='contactus'");
$cnt=1;
