...
<head>
  ...
  <title>IITG AMS || Tracking Page</title>
  ...
  <main id="main">
    ...
    <section class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          ...
          <ol>
            <li><a href="index.php" href="#main">Home</a></li>
    ...
    <!-- <section class="inner-page">
      <div class="container">
        ...
        <script>
          function goBack() {
            window.location.href = 'ambulance-tracking.php'; // Replace 'your_target_page.php' with your desired page
          }
        </script> -->
        <section class="inner-page">
      <div class="container">
